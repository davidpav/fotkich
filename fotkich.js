// David Pavlik, 2014
// Purposed solely for AWS 101 Training

// Loading express and other libraris
...
// LOCALHOST
// var REDIS_CONFIG = {host:'localhost', port:6379, prefix:'chs-sess'};
// var GOOGLE_RETURN_URL = 'http://localhost:3000/auth/google/return';
// var GOOGLE_REALM = 'http://localhost:3000/';

// PRODUCTION
var REDIS_CONFIG = {host:'fotkich.81oinn.0001.use1.cache.amazonaws.com', port:6379, prefix:'chs-sess'};
var GOOGLE_RETURN_URL = 'http://www.fotkich.com/auth/google/callback';
var GOOGLE_REALM = 'http://www.fotkich.com/';

var GOOGLE_CLIENT_ID =  "219629357131-ggkhi1l3jgi7b1p9bne4u8reqav5eru5.apps.googleusercontent.com";
var GOOGLE_CLIENT_SECRET = "hkC92NrxZQ1qFRrejmNDzldX";
...
passport.use(new GoogleStrategy({
  ...
  function(accessToken, refreshToken, profile, done) {
    process.nextTick(function () {
      ...
      var user = {'googleid' : profile.id, 'displayName' : profile.displayName, 'email' : email};      
...
app.use(express.session({ store: new RedisStore(REDIS_CONFIG), secret: 'SEKR37' }));
...
// Google Auth
app.get('/auth/google', passport.authenticate('google',{scope: ['https://www.googleapis.com/auth/userinfo.email','https://www.googleapis.com/auth/plus.login']}));
